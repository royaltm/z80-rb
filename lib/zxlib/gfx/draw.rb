  ...
  module Macros
    ...
    def draw_line_dx_gt_4dy(preshift, direction: :down, fx: :or, pixel_type: :pixel, scraddr:0x4000, check_oos:true, end_with: :eoc)
      ...
      isolate do |eoc|
        ...
        plot_fx3      label
        case fx
        when :or, :write, :nop, ZXGfxDraw::Constants::PLOT_FX_OR, ZXGfxDraw::Constants::PLOT_FX_NOP
                      ld   a, 0xFF           # filler
        middle_loop   ld   [hl], a
        when :xor, ZXGfxDraw::Constants::PLOT_FX_XOR
        middle_loop   ld   a, [hl]
                      cpl
                      ld   [hl], a
        when :and, ZXGfxDraw::Constants::PLOT_FX_AND
                      ld   a, 0              # filler
        middle_loop   ld   [hl], a
        when :none, ZXGfxDraw::Constants::PLOT_FX_NONE
                      nop
                      nop
        middle_loop   nop
        end
